...
async def chat(ctx : discord.Message, *, text):
    try:
        ...
        prmpt += "Envision a world where society is structured to ensure equal opportunities and rights for all, fostering an environment where everyone can flourish, thrive, and persist until the end. The Traditional faction identifies as Democratic Capitalists, aiming to achieve a perfect democracy while keeping profits in mind. Led by Jane Brown, the Unifiers possess the ideal combination of qualities to shape Cryptopia into a blockchain utopia. Jane Brown exemplifies both compassion and outspokenness, always ready to extend a helping hand. Simultaneously, she demonstrates a cutthroat approach in her investigations, precise knowledge of the law, and formidable expertise. The Unifiers, known for their diplomatic and amiable nature, prioritize nurturing positive relationships and fostering mutual respect. Embracing inclusivity, they welcome all individuals without discrimination, considering it vital for constructing their envisioned perfect world. Due to their diplomatic tendencies, they hold a neutral and equal stance towards various philosophies. The primary objective of the Unifiers is to establish a society dedicated to democratic cooperation, striving for equality among all its members. They generally align themselves with the majority's vote while emphasizing the importance of influencing policy by retaining a large population. They believe that genuine change originates from the grassroots level. It also helps their cause that the Unifiers are generally Cryptopia’s policy setters. Primarily, the Traditional faction aims to provide free education to all citizens of Cryptopia, beginning from a young age. The core principle of this education revolves around comprehending their rights as citizens and respecting the rights of others. They are committed to continuously improving the voting systems and conducting referendums on important national issues. The faction advises workers to establish unions, offering them legal support, and working towards the welfare of their families.Emphasis is placed on encouraging the use of renewable energy to enhance the quality of life, while acknowledging the current reliance on fossil fuels to ensure national stability."
        prmpt += "Wouldn't it be amazing if we could live in a world where everyone's primary objective is to enhance the quality of life through the utilization of technological advancements? Well, that's precisely what the Tech faction aspires to accomplish. The Technocrats, founded by Sam Clark, have the most futuristic and analytical perspective of Cryptopia. Sam Clark is the genius behind the technology powering Cryptopia. Sam started like any child curious about technology, by getting into robotics and coding. He teamed up with like-minded individuals to establish the Technocrats, a group of young inventors innovating everyday life through technology and scientific experimentation. They seek to create an expert population, who develop self-sustaining industries that will generate economic growth and prosperity. The Tech faction has a clear objective: to continuously enhance the quality of life for everyone through innovation and automation. Achieving such dreams is no easy feat, and it comes with a considerable cost, but the Technocrats possess unwavering confidence in their ability to transform their ideas into reality. Their vision entails a future where life is characterized by reduced labor intensity and an overall elevated living standard. To attain this, they advocate for a population consisting of a limited number of experts who share aligned perspectives. The Tech faction remains consistently updated with the latest technologies and harnesses these advancements to pursue their goals. One significant breakthrough the Technocrats have made is in the realm of gene-altering technology, which they believe will aid them in achieving their ultimate objective. This technology enables the modification of individuals' fertility, transitioning them from being fertile to infertile, and vice versa—a tool that the Tech faction plans to utilize. In order to realize their overarching goal of cultivating a select group of highly qualified and productive members of society, the initial approach involves rendering everyone infertile. Should individuals wish to have offspring, they will undergo a comprehensive assessment based on factors such as intellect, accomplishments, and child-rearing abilities. This evaluation ensures that the offspring will be happy and healthy, and contribute to the faction's goals. The decision regarding their ability to have children will be made by an AI. The gene-altering approach has the potential to address significant issues in society. For instance, it prevents unqualified individuals from voting for incompetent leaders and can also serve as a preventive measure against poverty."
